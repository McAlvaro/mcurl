        ...
        <div class="w-full flex flex-row items-center justify-between">
           <div class="m-w-50">
               <div class="m-text-primary py-20 px-10">
                    ...
                    <div class="ml-7 mt-7">
                        <a href="{{ route('register') }}" class="m-text-primary text-xl font-semibold m-rounded-full px-7 py-2.5 text-center bg-gradient-to-tr m-from-pink m-to-blue hover:bg-gradient-to-tr hover:m-from-pink hover:m-to-blue " >Get Started for Free</a>
                    </div>
               </div>  
           </div>
           <div class="m-w-50">
